...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ---------------- LIST ----------------
        ...
        # ❌ IMPORTANT: list should NOT be deleted
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in waiting_users:
        ...
        # delete user message (may fail if no permission)
        try:
        ...
        # send updated list (THIS IS IMPORTANT)
        list_msg = await update.message.reply_text(build_players_text())

        # optional: keep list or auto delete
        # asyncio.create_task(auto_delete(list_msg, 30))
