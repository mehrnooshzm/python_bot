...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Only allow registration in PV
    if chat_type != "private":
        await update.message.reply_text("ℹ️ Please register in private chat.")
        return

    # If user is waiting to send name
    if registrations.get(user_id) == "waiting":
