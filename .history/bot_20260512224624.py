...
waiting_jobs = {}
waiting_prompt_msg = {}
waiting_edit = {}  # user waiting for edit (row_id)
...
async def timeout_user(context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in waiting_users:
        ...
        msg = await context.bot.send_message(
            chat_id=chat_id,
            text="⏰ Time is finished. press Register again"
        )
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "register":
        ...
        msg = await query.message.reply_text("✍️ Send name now... (1 min)")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in waiting_edit:
        ...
        msg = await update.message.reply_text("✅ Updated!")
    ...
    if user_id in waiting_users:
        ...
        msg = await update.message.reply_text(f"✅ Saved: {text}")
        asyncio.create_task(auto_delete(msg, 5))
