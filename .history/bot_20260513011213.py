...
async def timeout_user(context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in waiting_users:
        ...
        msg = await context.bot.send_message(
            chat_id=chat_id, text="⏰ Time finished. Press Register again"
        )
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "register":
        ...
        msg = await context.bot.send_message(
            chat_id=chat_id, text="✍️ Send your name... (1 min)"
        )
    ...
    # ---------------- MY EDIT ----------------
        ...
        if not found:
            ...
            msg = await context.bot.send_message(
                chat_id=chat_id, text="⚠️ You are not registered"
            )
    ...
    # ---------------- DELETE ----------------
        ...
        msg = await context.bot.send_message(chat_id=chat_id, text="✅ Deleted!")
